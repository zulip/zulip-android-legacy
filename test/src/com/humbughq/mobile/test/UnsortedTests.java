...
public class UnsortedTests extends ActivityUnitTestCase<HumbugActivity> {
    ...
    private void testInit() {
        setApplication(app);
        this.startActivity(new Intent(getInstrumentation().getTargetContext(), HumbugActivity.class), null, null);
        this.getInstrumentation().waitForIdleSync();
        app.setContext(getInstrumentation().getTargetContext());
        ((ZulipApp) getActivity().getApplication()).setEmail("testuser@example.com");
